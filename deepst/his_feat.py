...
class image_feature:
    ...
    def load_cnn_model(
        ...
        if self.cnnType == 'ResNet50':
            ...
            cnn_pretrained_model = models.resnet152(weights=models.ResNet152_Weights.DEFAULT)
            cnn_pretrained_model.to(self.device)
        elif self.cnnType == 'Vgg19':
            cnn_pretrained_model = models.vgg19(weights=models.VGG19_Weights.DEFAULT)
            cnn_pretrained_model.to(self.device)
        elif self.cnnType == 'Vgg16':
            cnn_pretrained_model = models.vgg16(weights=models.VGG16_Weights.DEFAULT)
            cnn_pretrained_model.to(self.device)
